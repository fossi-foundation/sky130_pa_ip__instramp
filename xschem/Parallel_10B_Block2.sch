...
C {devices/lab_pin.sym} -550 -600 1 0 {name=p5 sig_type=std_logic lab=DVDD}
C {devices/lab_pin.sym} -1560 -300 0 0 {name=p10 sig_type=std_logic lab=Vx32}
C {Universal_R_2R_Block2.sym} -1310 -510 0 0 {name=x5}
C {Universal_R_2R_Block2.sym} -1120 -510 0 0 {name=x1}
...
C {devices/lab_pin.sym} -740 -240 1 0 {name=p21 sig_type=std_logic lab=DVDD}
C {devices/lab_pin.sym} -550 -240 1 0 {name=p22 sig_type=std_logic lab=DVDD}
C {Universal_R_2R_Block2.sym} -1310 -150 0 0 {name=x9}
C {Universal_R_2R_Block2.sym} -1120 -150 0 0 {name=x10}
...
C {devices/iopin.sym} -1410 -750 3 0 {name=p14 lab=V5}
C {devices/iopin.sym} -1220 -750 3 0 {name=p16 lab=V6}
C {devices/iopin.sym} -1030 -750 3 0 {name=p18 lab=V7}
C {devices/iopin.sym} -840 -750 3 0 {name=p23 lab=V8}
C {devices/iopin.sym} -650 -750 3 0 {name=p24 lab=V9}
C {devices/iopin.sym} -1410 -380 3 0 {name=p25 lab=V0}
C {devices/iopin.sym} -1220 -380 3 0 {name=p29 lab=V1}
C {devices/iopin.sym} -1030 -380 3 0 {name=p30 lab=V2}
C {devices/iopin.sym} -840 -380 3 0 {name=p32 lab=V3}
C {devices/iopin.sym} -650 -380 3 0 {name=p33 lab=V4}
C {Output_OA.sym} -170 -450 0 0 {name=x7}
C {x1_x32_OA.sym} -1680 -710 0 0 {name=x6}
C {x1_x32_OA.sym} -1680 -350 0 0 {name=x8}
C {devices/iopin.sym} -1830 -160 0 1 {name=p6 lab=AVSS}
C {lab_pin.sym} -1800 -160 0 1 {name=p35 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -1680 -660 1 1 {name=p36 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -1680 -300 1 1 {name=p37 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -880 -820 2 1 {name=p38 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -150 -820 1 1 {name=p39 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -170 -400 1 1 {name=p40 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -420 -450 0 0 {name=p41 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -420 -90 0 0 {name=p42 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -1840 -830 1 1 {name=p43 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -1610 -830 1 1 {name=p44 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -1610 -470 1 1 {name=p45 sig_type=std_logic lab=AVSS}
...
C {lab_pin.sym} -1660 -390 0 1 {name=p54 sig_type=std_logic lab=VBIAS}
C {lab_pin.sym} -150 -490 0 1 {name=p55 sig_type=std_logic lab=VBIAS}
C {devices/lab_pin.sym} -1340 -240 1 0 {name=p56 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -1150 -240 1 0 {name=p57 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -960 -240 1 0 {name=p58 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -770 -240 1 0 {name=p59 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -580 -240 1 0 {name=p60 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -580 -600 1 0 {name=p61 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -770 -600 1 0 {name=p62 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -960 -600 1 0 {name=p63 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -1150 -600 1 0 {name=p64 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} -1340 -600 1 0 {name=p65 sig_type=std_logic lab=AVDD}
C {devices/iopin.sym} -1830 -90 0 1 {name=p66 lab=AVDD}
C {lab_pin.sym} -1800 -90 0 1 {name=p67 sig_type=std_logic lab=AVDD}
C {devices/iopin.sym} -1830 -60 0 1 {name=p68 lab=DVDD}
