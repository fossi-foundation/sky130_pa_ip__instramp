...
C {devices/iopin.sym} -170 0 0 1 {name=p9 lab=DVDD}
...
C {lab_pin.sym} 440 -230 0 0 {name=p14 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} 190 -230 0 1 {name=p15 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} -140 0 0 1 {name=p16 sig_type=std_logic lab=DVDD}
...
spiceprefix=X
mult=1}
C {sky130_stdcells/diode_2.sym} -70 -210 0 0 {name=x3 VGND=DVSS VNB=DVSS VPB=AVDD VPWR=AVDD prefix=sky130_fd_sc_hvl__ }
C {devices/iopin.sym} -160 -30 0 1 {name=p10 lab=DVSS}
C {lab_pin.sym} -30 -30 0 1 {name=p18 sig_type=std_logic lab=DVSS}
